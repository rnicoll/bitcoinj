 ...
 */
public interface BlockChainListener<T extends Block> {
    /**
     ...
     */
    void notifyNewBestBlock(StoredBlock<T> block) throws VerificationException;
     ...
     */
    void reorganize(StoredBlock<T> splitPoint, List<StoredBlock<T>> oldBlocks,
                    List<StoredBlock<T>> newBlocks) throws VerificationException;
     ...
     */
    boolean isTransactionRelevant(Transaction<T> tx) throws ScriptException;
     ...
     */
    void receiveFromBlock(Transaction<T> tx, StoredBlock<T> block,
     ...
     */
    boolean notifyTransactionIsInBlock(Sha256Hash txHash, StoredBlock<T> block,
                                       BlockChain.NewBlockType blockType,
                                       int relativityOffset) throws VerificationException;
}
